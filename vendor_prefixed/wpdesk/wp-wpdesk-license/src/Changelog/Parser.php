...
namespace CPWFreeVendor\WPDesk\License\Changelog;

use ArrayObject;
use CPWFreeVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \CPWFreeVendor\WPDesk\License\Changelog\Parser\Line($line);
