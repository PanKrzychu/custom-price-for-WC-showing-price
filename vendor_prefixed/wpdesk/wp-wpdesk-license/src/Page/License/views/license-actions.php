...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\esc_html(\__('Key:', 'custom-price-for-woocommerce'));
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\esc_html(\__('Email:', 'custom-price-for-woocommerce'));
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    echo \esc_html(\__('Activate', 'custom-price-for-woocommerce'));
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    echo \esc_html(\__('Deactivate', 'custom-price-for-woocommerce'));
    ?></button>
				<?php 
}
?>
