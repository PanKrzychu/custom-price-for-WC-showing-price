...
namespace CPWFreeVendor\WPDesk\License\ActivationForm;

use CPWFreeVendor\WPDesk\License\LicenseManager;
use CPWFreeVendor\WPDesk\License\Page\LicensePageActions;
use CPWFreeVendor\WPDesk\License\PluginLicense;
 ...
 */
class AjaxHandler implements \CPWFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \CPWFreeVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \CPWFreeVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        ...
        $plugin_license = new \CPWFreeVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \CPWFreeVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
