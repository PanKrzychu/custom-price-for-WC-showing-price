 ...
 */
class PluginsPageRenderer implements \CPWFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file, $plugin_data)
    {
        ...
        $form_content = new \CPWFreeVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info, $update_possible);
