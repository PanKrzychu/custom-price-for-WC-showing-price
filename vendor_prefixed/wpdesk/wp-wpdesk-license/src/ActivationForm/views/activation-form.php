...
?>";
			let nonce = "<?php 
echo \esc_attr(\wp_create_nonce(\CPWFreeVendor\WPDesk\License\ActivationForm\AjaxHandler::AJAX_ACTION));
?>";
			let alert_text = "<?php 
echo \esc_attr(\__('The action failed with an error: ', 'custom-price-for-woocommerce'));
?>";
			let enter_license_key = "<?php 
echo \esc_attr(\__('Enter license key', 'custom-price-for-woocommerce'));
?>";
