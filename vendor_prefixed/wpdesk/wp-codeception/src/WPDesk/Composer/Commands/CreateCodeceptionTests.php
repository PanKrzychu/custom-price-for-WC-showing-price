 ...
 */
class CreateCodeceptionTests extends \CPWFreeVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \CPWFreeVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
