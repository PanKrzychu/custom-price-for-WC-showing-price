...
if (!\interface_exists('CPWFreeVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('CPWFreeVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \CPWFreeVendor\WPDesk_Requirement_Checker
    {
