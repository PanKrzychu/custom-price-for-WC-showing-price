...
if (!\class_exists('CPWFreeVendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('CPWFreeVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \CPWFreeVendor\WPDesk_Basic_Requirement_Checker
    {
        /**
