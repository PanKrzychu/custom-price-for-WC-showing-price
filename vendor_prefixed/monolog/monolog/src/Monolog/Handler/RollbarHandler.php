...
use CPWFreeVendor\RollbarNotifier;
use Exception;
 ...
 */
class RollbarHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Rollbar notifier
     *
    ...
    protected $levelMap = array(\CPWFreeVendor\Monolog\Logger::DEBUG => 'debug', \CPWFreeVendor\Monolog\Logger::INFO => 'info', \CPWFreeVendor\Monolog\Logger::NOTICE => 'info', \CPWFreeVendor\Monolog\Logger::WARNING => 'warning', \CPWFreeVendor\Monolog\Logger::ERROR => 'error', \CPWFreeVendor\Monolog\Logger::CRITICAL => 'critical', \CPWFreeVendor\Monolog\Logger::ALERT => 'critical', \CPWFreeVendor\Monolog\Logger::EMERGENCY => 'critical');
    /**
     ...
     */
    public function __construct(\CPWFreeVendor\RollbarNotifier $rollbarNotifier, $level = \CPWFreeVendor\Monolog\Logger::ERROR, $bubble = \true)
    {
