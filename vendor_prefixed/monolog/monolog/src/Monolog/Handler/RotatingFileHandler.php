 ...
 */
class RotatingFileHandler extends \CPWFreeVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \CPWFreeVendor\Monolog\Utils::canonicalizePath($filename);
