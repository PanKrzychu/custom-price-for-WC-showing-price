 ...
 */
class BrowserConsoleHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \CPWFreeVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
