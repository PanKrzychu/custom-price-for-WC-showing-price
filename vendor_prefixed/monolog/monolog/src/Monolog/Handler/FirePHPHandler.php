...
use CPWFreeVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \CPWFreeVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
