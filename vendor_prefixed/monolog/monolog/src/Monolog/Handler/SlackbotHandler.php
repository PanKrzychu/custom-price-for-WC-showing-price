 ...
 */
class SlackbotHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \CPWFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
