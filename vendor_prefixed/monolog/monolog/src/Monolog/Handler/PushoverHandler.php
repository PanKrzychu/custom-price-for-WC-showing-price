 ...
 */
class PushoverHandler extends \CPWFreeVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \CPWFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \CPWFreeVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \CPWFreeVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \CPWFreeVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \CPWFreeVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
