 ...
 */
abstract class AbstractHandler implements \CPWFreeVendor\Monolog\Handler\HandlerInterface, \CPWFreeVendor\Monolog\ResettableInterface
{
    protected $level = \CPWFreeVendor\Monolog\Logger::DEBUG;
