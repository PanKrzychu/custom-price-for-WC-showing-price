 ...
 */
namespace CPWFreeVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \CPWFreeVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \CPWFreeVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \CPWFreeVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \CPWFreeVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \CPWFreeVendor\Monolog\Logger::INFO:
    ...
    public function stringify($fields)
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \CPWFreeVendor\Monolog\Utils::jsonEncode($normalized, $prettyPrintFlag | $flags) : \CPWFreeVendor\Monolog\Utils::jsonEncode($normalized, $flags);
    }
    /**
     * Sets the formatter
     *
