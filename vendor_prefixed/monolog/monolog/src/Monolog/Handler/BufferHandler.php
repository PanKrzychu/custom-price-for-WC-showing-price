 ...
 */
class BufferHandler extends \CPWFreeVendor\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\CPWFreeVendor\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
